...
/// @nodoc
mixin _$MainState {
  List<ImageModel> get imageItems => throw _privateConstructorUsedError;
...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ImageModel> imageItems, bool isLoading});
}
...
class _$MainStateImpl with DiagnosticableTreeMixin implements _MainState {
  const _$MainStateImpl(
      {final List<ImageModel> imageItems = const [], this.isLoading = false})
      : _imageItems = imageItems;

  factory _$MainStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$MainStateImplFromJson(json);

  final List<ImageModel> _imageItems;
  @override
  @JsonKey()
  List<ImageModel> get imageItems {
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_imageItems), isLoading);
