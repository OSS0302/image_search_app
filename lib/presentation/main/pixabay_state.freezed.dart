...
mixin _$PixabayState {
  List<PixabayItem> get imageItem => throw _privateConstructorUsedError;
...
abstract class $PixabayStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PixabayItem> imageItem, bool isLoading});
}
...
class _$PixabayStateImpl with DiagnosticableTreeMixin implements _PixabayState {
  const _$PixabayStateImpl(
      {final List<PixabayItem> imageItem = const [], this.isLoading = false})
      : _imageItem = imageItem;

  factory _$PixabayStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$PixabayStateImplFromJson(json);

  final List<PixabayItem> _imageItem;
  @override
  @JsonKey()
  List<PixabayItem> get imageItem {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PixabayState(imageItem: $imageItem, isLoading: $isLoading)';
  }
...
abstract class _PixabayState implements PixabayState {
  const factory _PixabayState(
      {final List<PixabayItem> imageItem,
